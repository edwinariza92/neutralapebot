...
bb_length = int(os.getenv('BB_LENGTH', '18'))  # Periodo por defecto para Bandas de Bollinger
bb_mult = float(os.getenv('BB_MULT', '3.0'))  # Multiplicador por defecto para Bandas de Bollinger
atr_length = int(os.getenv('ATR_LENGTH', '4'))  # Periodo por defecto para ATR
ma_trend_length = int(os.getenv('MA_TREND_LENGTH', '50'))  # Periodo por defecto para MA de tendencia
tp_multiplier = float(os.getenv('TP_MULTIPLIER', '2.6'))  # Multiplicador por defecto para Take Profit
sl_multiplier = float(os.getenv('SL_MULTIPLIER', '1.5'))  # Multiplicador por defecto para Stop Loss
...
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN', '8553357230:AAHUPndyU9x1ywOaJ2dVMfavQtmPfX4A2TA')
